 ...
 * @generated
 */
public class Sysmanage_codeServiceImpl implements IService {
	
	private static final Sysmanage_codeServiceImpl _instance = new Sysmanage_codeServiceImpl();
	
	private Sysmanage_codeServiceImpl() {}
	
	public static Sysmanage_codeServiceImpl getInstance(){
		return _instance;
	}
	...
	public int deleteById(Object $object, ConnSession $session)
		...
		try{
			...
			__result = DaoFactory.getInstance().getDao(DaoFactory.SYSMANAGE_CODEDAO).deleteById(__sysmanage_code, $session);
	...
	public int delete(Object $object, ConnSession $session)
		...
		try{
			...
			DaoFactory.getInstance().getDao(DaoFactory.SYSMANAGE_CODEDAO).delete(__sysmanage_code, $session);
			
			String __detailTablesName = __sysmanage_code.getDetailTablesName();
			...
			if(__detailTablesName != null && !"".equals(__detailTablesName.trim())){
				...
				for(int ___i=0,___j=___detailTablesNameStrs.length; ___i<___j; ___i++){
					...
					Ognl.setValue("tab_sysmanage_code_id", ____object, __sysmanage_code.getId());
	...
	public boolean deletes(List $list, ConnSession $session)
		...
		try{
			...
			for(int __i=0, __j=($list == null ? 0 : $list.size()); __i<__j; __i++){
				DaoFactory.getInstance().getDao(DaoFactory.SYSMANAGE_CODEDAO).delete($list.get(__i), $session);
			}
	...
	public Object insert(Object $object, ConnSession $session)
		...
		try{
			...
			Sysmanage_code ___sysmanage_code = (Sysmanage_code)$object;
			
			__id = DaoFactory.getInstance().getDao(DaoFactory.SYSMANAGE_CODEDAO).insert(___sysmanage_code, $session);
	...
	public boolean inserts(List $list, ConnSession $session)
		...
		try{
			...
			for(int __i=0, __j=($list == null ? 0 : $list.size()); __i<__j; __i++){
				Sysmanage_code ___sysmanage_code = (Sysmanage_code)$list.get(__i);
				int ___id = DaoFactory.getInstance().getDao(DaoFactory.SYSMANAGE_CODEDAO).insert(___sysmanage_code, $session);
			}
	...
	public List select(Object $object, ConnSession $session)
		...
		try{
			Sysmanage_code __sysmanage_code = (Sysmanage_code)$object;
			return DaoFactory.getInstance().getDao(DaoFactory.SYSMANAGE_CODEDAO).select(__sysmanage_code, $session);
		}
		catch(Exception $ex){
			throw new ServiceException($ex.getMessage(), $ex);
		}
	...
	public List select2(Object $object, ConnSession $session)
		...
		try{
			Sysmanage_code __sysmanage_code = (Sysmanage_code)$object;
			return DaoFactory.getInstance().getDao(DaoFactory.SYSMANAGE_CODEDAO).select2(__sysmanage_code, $session);
		}
		catch(Exception $ex){
			throw new ServiceException($ex.getMessage(), $ex);
		}
	...
	public Object selectById(Object $object, ConnSession $session)
		...
		try{
			Sysmanage_code __sysmanage_code = (Sysmanage_code)$object;
			return DaoFactory.getInstance().getDao(DaoFactory.SYSMANAGE_CODEDAO).selectById(__sysmanage_code, $session);
		}
		catch(Exception $ex){
			throw new ServiceException($ex.getMessage(), $ex);
		}
	...
	public int selectCount(Object $object, ConnSession $session)
		...
		try{
			Sysmanage_code __sysmanage_code = (Sysmanage_code)$object;
			return DaoFactory.getInstance().getDao(DaoFactory.SYSMANAGE_CODEDAO).selectCount(__sysmanage_code, $session);
		}
		catch(Exception $ex){
			throw new ServiceException($ex.getMessage(), $ex);
		}
	...
	public int update(Object $object, ConnSession $session)
		...
		try{
			...
			DaoFactory.getInstance().getDao(DaoFactory.SYSMANAGE_CODEDAO).update(__sysmanage_code, $session);
			
//			String __detailTable = __sysmanage_code.getDetailTable();
//			
...
//						
//						if(__sysmanage_code.getDetailTablesName().indexOf(_____jsonObject.get("tab").toString()) == -1) continue;
//						
...
//
//						Ognl.setValue("tab_sysmanage_code_id", _____object, __sysmanage_code.getId());
//						
...
//			}
			...
			_result = __sysmanage_code.getId();
	...
	public boolean updates(List $list, ConnSession $session)
		...
		try{
			...
			for(int __i=0, __j=($list == null ? 0 : $list.size()); __i<__j; __i++){
				DaoFactory.getInstance().getDao(DaoFactory.SYSMANAGE_CODEDAO).update($list.get(__i), $session);
			}
