 ...
 * @generated
 */
public class Sysmanage_websiteServiceImpl implements IService {
	
	private static final Sysmanage_websiteServiceImpl _instance = new Sysmanage_websiteServiceImpl();
	
	private Sysmanage_websiteServiceImpl() {}
	
	public static Sysmanage_websiteServiceImpl getInstance(){
		return _instance;
	}
	...
	public int deleteById(Object $object, ConnSession $session)
		...
		try{
			...
			__result = DaoFactory.getInstance().getDao(DaoFactory.SYSMANAGE_WEBSITEDAO).deleteById(__sysmanage_website, $session);
	...
	public int delete(Object $object, ConnSession $session)
		...
		try{
			...
			DaoFactory.getInstance().getDao(DaoFactory.SYSMANAGE_WEBSITEDAO).delete(__sysmanage_website, $session);
			
			String __detailTablesName = __sysmanage_website.getDetailTablesName();
			...
			if(__detailTablesName != null && !"".equals(__detailTablesName.trim())){
				...
				for(int ___i=0,___j=___detailTablesNameStrs.length; ___i<___j; ___i++){
					...
					Ognl.setValue("tab_sysmanage_website_id", ____object, __sysmanage_website.getId());
	...
	public boolean deletes(List $list, ConnSession $session)
		...
		try{
			...
			for(int __i=0, __j=($list == null ? 0 : $list.size()); __i<__j; __i++){
				DaoFactory.getInstance().getDao(DaoFactory.SYSMANAGE_WEBSITEDAO).delete($list.get(__i), $session);
			}
	...
	public Object insert(Object $object, ConnSession $session)
		...
		try{
			...
			Sysmanage_website ___sysmanage_website = (Sysmanage_website)$object;
			
			__id = DaoFactory.getInstance().getDao(DaoFactory.SYSMANAGE_WEBSITEDAO).insert(___sysmanage_website, $session);
	...
	public boolean inserts(List $list, ConnSession $session)
		...
		try{
			...
			for(int __i=0, __j=($list == null ? 0 : $list.size()); __i<__j; __i++){
				Sysmanage_website ___sysmanage_website = (Sysmanage_website)$list.get(__i);
				int ___id = DaoFactory.getInstance().getDao(DaoFactory.SYSMANAGE_WEBSITEDAO).insert(___sysmanage_website, $session);
			}
	...
	public List select(Object $object, ConnSession $session)
		...
		try{
			Sysmanage_website __sysmanage_website = (Sysmanage_website)$object;
			return DaoFactory.getInstance().getDao(DaoFactory.SYSMANAGE_WEBSITEDAO).select(__sysmanage_website, $session);
		}
		catch(Exception $ex){
			throw new ServiceException($ex.getMessage(), $ex);
		}
	...
	public List select2(Object $object, ConnSession $session)
		...
		try{
			Sysmanage_website __sysmanage_website = (Sysmanage_website)$object;
			return DaoFactory.getInstance().getDao(DaoFactory.SYSMANAGE_WEBSITEDAO).select2(__sysmanage_website, $session);
		}
		catch(Exception $ex){
			throw new ServiceException($ex.getMessage(), $ex);
		}
	...
	public Object selectById(Object $object, ConnSession $session)
		...
		try{
			Sysmanage_website __sysmanage_website = (Sysmanage_website)$object;
			return DaoFactory.getInstance().getDao(DaoFactory.SYSMANAGE_WEBSITEDAO).selectById(__sysmanage_website, $session);
		}
		catch(Exception $ex){
			throw new ServiceException($ex.getMessage(), $ex);
		}
	...
	public int selectCount(Object $object, ConnSession $session)
		...
		try{
			Sysmanage_website __sysmanage_website = (Sysmanage_website)$object;
			return DaoFactory.getInstance().getDao(DaoFactory.SYSMANAGE_WEBSITEDAO).selectCount(__sysmanage_website, $session);
		}
		catch(Exception $ex){
			throw new ServiceException($ex.getMessage(), $ex);
		}
	...
	public int update(Object $object, ConnSession $session)
		...
		try{
			...
			DaoFactory.getInstance().getDao(DaoFactory.SYSMANAGE_WEBSITEDAO).update(__sysmanage_website, $session);
			
//			String __detailTable = __sysmanage_website.getDetailTable();
//			
...
//						
//						if(__sysmanage_website.getDetailTablesName().indexOf(_____jsonObject.get("tab").toString()) == -1) continue;
//						
...
//
//						Ognl.setValue("tab_sysmanage_code_id", _____object, __sysmanage_website.getId());
//						
...
//			}
			...
			_result = __sysmanage_website.getId();
	...
	public boolean updates(List $list, ConnSession $session)
		...
		try{
			...
			for(int __i=0, __j=($list == null ? 0 : $list.size()); __i<__j; __i++){
				DaoFactory.getInstance().getDao(DaoFactory.SYSMANAGE_WEBSITEDAO).update($list.get(__i), $session);
			}
