 ...
 * </p>
 * function 1:dateintstr(StrDate) :把字符串转为日期并初始化各部份 StrDate:日期格式的字符串. function
 * 2:dateint() : 初始化当前日期的各部份 function 3:getnoncetime() : 取当前系统时间并精确到毫秒 function
 * 4:getymd() :取当前系统时间的年月日 function 5:getTime() :取出当前系统的时分秒 function
 * 6:getFormatDate(Format) :格式化当前系统时间 Format：支持以下格式: yyyy-MM-dd格式:年月日
 * 
 * yyyy/MM/dd格式:年月日
 * 
 * yyyyMMdd格式:年月日
 ...
 * mm格式:当前月份
 * 
 * dd格式:当月的当前的哪一天. function 7:getFormatDateS(Format,StrDate) :格式化当前系统时间 Format
 * ：支持以下格式:以上； StrDate:日期字符串。
 * <p>
...
public class DateUtil {
	...
	public String getnoncetime() {
		dateint(); // 初始化时间控件.
		sNowTime = yyyy + "-" + Smm + "-" + Sdd + " " + Shh + ":" + Smi + ":" + Sss + "." + ms;
		return sNowTime;
	}
