...
define(["dojo/_base/declare",
	...
	"capec/utils/ajax"], function($declare, $ItemFileReadStore, $connect,$ItemFileWriteStore,$EnhancedGrid, $lang, $ContentPane,$randomUrl,$ajax) {
	return $declare("internal.sys.group.RoleRelatGrid", $ContentPane, {
		...
		loadData: function($groupid){
			...
			var __param = {
				...
				url : this.vpath +"testData/group_role_r.json",
		...
		_addGrid: function(){
			this._grid = new $EnhancedGrid({
				...
				structure: [{
					...
					{ name: "编号", field: "roleid", width: "auto" },
					{ name: "角色名", field: "rolename", width: "auto" },
					{ name: "所属域", field: "domainname", width: "auto" }
					]
				]
		...
		getAllItems: function(){
			return this._grid.store._getItemsArray();
		},
		getSelectItems: function(){
			...
			for(var __i_3=0,__item_3; __item_3=__items[__i_3]; __i_3++){
				var __item_4 = {
					...
					rolename: __item_3.rolename[0],
					domainname: __item_3.domainname[0]
				};
