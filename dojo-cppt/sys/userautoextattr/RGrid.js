		...
		_addGrid: function(){
			this._grid = new $EnhancedGrid({
				...
				structure: [{
					...
					{ name: "属性名称", field: "batchname", width: "100px" },
					{ name: "属性描述", field: "info", width: "100px" },
					{ name: "数据类型", field: "info", width: "100px" },
					{ name: "数据长度", field: "info", width: "100px" },
					{ name: "数据精度", field: "info", width: "100px" },
					{ name: "状态", field: "info", width: "100px" },
