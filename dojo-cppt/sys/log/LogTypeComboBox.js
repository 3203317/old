...
define(["dojo/_base/declare",
	...
	return $declare("internal.sys.log.LogTypeComboBox", $ComboBox, {
		postCreate : function() {
		...
		_loadData: function(){
			var __param = {
				...
				handleAs : "json",
				content: {},
				url : $randomUrl(this.vpath +"testData/logtype.json"),
		...
		_onDataLoaded: function($data){
			if($data != null){
				for(var __i=0,__j=$data.items.length; __i<__j; __i++){
					this.addOption({ label: $data.items[__i]["logtypename"], value: $data.items[__i]["id"] });
				}
			}
		},
		_onError: function(){
