...
define(["dojo/_base/declare",
	...
	return $declare("internal/sys/org/Grid", $ContentPane, {
		_store: null,
		_dialog: null,
		_toolbar: null,
		...
		_onSelectedItem: function(){
			...
			this._toolbar.disableBatch(this._grid.selection.getSelectedCount() != 1);
		},
		postCreate : function() {
		...
		_addGrid: function(){
			this._grid = new $EnhancedGrid({
				...
				structure: [{
					...
					{ name: "机构名称", field: "orgname", width: "120px" },
					{ name: "机构别名", field: "sex", width: "auto" },
