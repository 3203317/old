	...
	return $declare(null,{
		...
		loadData: function($orgId){
			this._grid.setStore(new $QueryReadStore({
				url : this.vpath +"testData/user_o"+ $orgId +".json?orgId="+ $orgId,
				requestMethod: "post"
			}));
		},
...
//			$formParams.orgId = this._tree.getSelectedItem().id[0];
//			$ajax({
//				async : false,
//				content: $formParams,
//				url : this.vpath +"testData/user_o"+ $formParams.orgId +".json",
