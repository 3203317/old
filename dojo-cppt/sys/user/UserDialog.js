...
define(["dojo/_base/connect",
	...
	return $declare($FormDialog,{
		fid: "internal_sys_user_UserForm",
		title: $i18n.title_Create,
		href: "sys/user/userForm.html",
		style: { height: "420px", width: "680px" },
		_grid: null,
		_store: null,
		...
		_submit: function(){
			if(this._valid()){
				...
				__newItem.open_date = dijit.byId(this.fid +"_open_dateText").displayedValue;
				__newItem.orgid = dijit.byId(this.fid +"_dept_codeText").key;
		...
		_setData: function(){
			if(this.model == "Create"){
				...
				dijit.byId(this.fid +"_nameText").set("value", __data_3.i.username);
				dijit.byId(this.fid +"_dept_codeText").set("value", "呵呵");
				dijit.byId(this.fid +"_dept_codeText").set("key", "121");
