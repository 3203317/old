...
define(["dojo/_base/declare",
	...
	return $declare($ContentPane, {
		...
		_onDblClickItem: function(){
			if(this._grid.selection.getSelectedCount() == 1 && this._toolbar._editBtn.get("optStatus") == 1){
		...
		_onSelectedItem: function(){
			...
			this._toolbar.disablePer(this._grid.selection.getSelectedCount() != 1);
		...
		_addGrid: function(){
			this._grid = new $EnhancedGrid({
				...
				structure: [{
					...
					{ name: "角色名称", field: "rolename", width: "100px" },
					{ name: "用户单位", field: "userunit", width: "100px" },
					{ name: "所属域", field: "domain", width: "100px" },
					{ name: "允许继承", field: "inherit", width: "100px" },
					{ name: "最大用户量", field: "maxusernumber", width: "100px" },
					{ name: "用户量限制", field: "userlimit", width: "100px" },
					{ name: "最大组量", field: "maxgroupnumber", width: "100px" },
					{ name: "组量限制", field: "grouplimit", width: "100px" },
