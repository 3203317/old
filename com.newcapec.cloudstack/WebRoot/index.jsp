...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
        ...
        <form>
          ...
          <div class="fields">
            ...
            <div class="field username">
              ...
              <input type="text" name="username" class="required" value="admin" />
            </div>

            <!-- Password -->
            <div class="field password">
              <label for="password"><fmt:message key="label.password"/></label>
              <input type="password" name="password" class="required"  value="888888" />
            </div>
    ...
    <script src="scripts/configuration2.js" type="text/javascript"></script>
...
'label.menu.service.offerings2': '<fmt:message key="label.menu.service.offerings2" />',
