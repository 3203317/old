...
import cn.newcapec.function.citycard.platform.privilege.dao.RoleResourceDAO;
...
public class WelcomeResource extends PrivilegeResource {
	...
	public void welcome(BaseRequest request, BaseResponse response) {
		String url = "/function/citycard/platform/privilege/v1.0/welcome/pagelet/welcome.html";
	...
	public void SysSwitch(BaseRequest request, BaseResponse response) {
		String url = "/function/citycard/platform/portal/v1.0/switch/pagelet/switch.html";
		response.toView(url, getNewcapectViewContext());
	}
	...
	public void commonFunction(BaseRequest request, BaseResponse response) {
		String url = "/function/citycard/platform/privilege/v1.0/welcome/pagelet/commonFunction.html";
		response.toView(url, getNewcapectViewContext());
	}
