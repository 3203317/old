...
import cn.newcapec.function.citycard.platform.privilege.biz.UserDepartmentService;
import cn.newcapec.function.citycard.platform.privilege.model.Department;
...
public class DepartmentResource extends PrivilegeResource {
	...
	public void departmentListUI(BaseRequest request, BaseResponse response) {
		String url = "/function/citycard/platform/privilege/v1.0/department/pagelet/department_list.html";
	...
	public void departmentListGrid(BaseRequest request, BaseResponse response) {
		String url = "/function/citycard/platform/privilege/v1.0/department/pagelet/department_list_grid.html";
		/* 查询列表 */
	...
	public void addDepartmentUI(BaseRequest request, BaseResponse response) {
		String url = "/function/citycard/platform/privilege/v1.0/department/pagelet/add_department_ui.html";
		response.toView(url, getNewcapectViewContext());
	}
...
//					department.setIsParent("false");
	...
	public void findDepartment(BaseRequest request, BaseResponse response) {
		String url = "/function/citycard/platform/privilege/v1.0/department/pagelet/update_department_ui.html";
		try {
