...
import cn.newcapec.function.citycard.platform.privilege.model.Resource;
...
public class ResourceResource extends PrivilegeResource {
	...
	public void resourceListUI(BaseRequest request, BaseResponse response) {
		String url = "/function/citycard/platform/privilege/v1.0/resource/pagelet/resource_list.html";
	...
	public void resourceListGrid(BaseRequest request, BaseResponse response) {
		String url = "/function/citycard/platform/privilege/v1.0/resource/pagelet/resource_list_grid.html";
		/* 查询列表 */
	...
	public void addResourceUI(BaseRequest request, BaseResponse response) {
		String url = "/function/citycard/platform/privilege/v1.0/resource/pagelet/addResourceUI.html";
		response.toView(url, getNewcapectViewContext());
	}
	...
	public void editResourceUI(BaseRequest request, BaseResponse response) {
		String url = "/function/citycard/platform/privilege/v1.0/resource/pagelet/editResourceUI.html";
		response.toView(url, getNewcapectViewContext());
	}
