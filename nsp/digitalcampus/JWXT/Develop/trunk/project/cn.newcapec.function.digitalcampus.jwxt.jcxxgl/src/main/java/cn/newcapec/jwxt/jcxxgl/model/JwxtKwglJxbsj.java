...
/**
 * JwxtKwglJxbsj entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name="JWXT_KWGL_JXBSJ"
    ,schema="JWXT"
)

public class JwxtKwglJxbsj extends cn.newcapec.function.digitalcampus.common.model.AbstractModel implements java.io.Serializable {
    ...
    /** default constructor */
    public JwxtKwglJxbsj() {
    }

	/** minimal constructor */
    public JwxtKwglJxbsj(String id, String bjbh, String bjmc, String zybh, BigDecimal rxnf, String xnxq, BigDecimal xsrs, String kssj, String cjr, String jlssdw, Date cjsj) {
        this.id = id;
        this.bjbh = bjbh;
        this.bjmc = bjmc;
        this.zybh = zybh;
    ...
    /** full constructor */
    public JwxtKwglJxbsj(String id, String bjbh, String bjmc, String zybh, BigDecimal rxnf, String xnxq, BigDecimal xsrs, String kssj, String cjr, String jlssdw, Date whsj, Date cjsj) {
        this.id = id;
        this.bjbh = bjbh;
        this.bjmc = bjmc;
        this.zybh = zybh;
