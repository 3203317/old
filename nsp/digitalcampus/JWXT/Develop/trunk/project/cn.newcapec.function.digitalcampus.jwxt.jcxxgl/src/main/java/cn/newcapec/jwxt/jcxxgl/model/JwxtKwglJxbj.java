...
/**
 * JwxtKwglJxbj entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name="JWXT_KWGL_JXBJ"
    ,schema="JWXT"
)

public class JwxtKwglJxbj extends cn.newcapec.function.digitalcampus.common.model.AbstractModel implements java.io.Serializable {
	...
	/** minimal constructor */
    public JwxtKwglJxbj(String id, String bjbh, String bjmc, String zybh, BigDecimal rxnf, String xnxq, String kslx, BigDecimal xsrs, String cjr, String jlssdw, Date cjsj) {
        this.id = id;
        this.bjbh = bjbh;
        this.bjmc = bjmc;
        this.zybh = zybh;
    ...
    /** full constructor */
    public JwxtKwglJxbj(String id, String bjbh, String bjmc, String zybh, BigDecimal rxnf, String xnxq, String kslx, BigDecimal xsrs, String cjr, String jlssdw, Date whsj, Date cjsj) {
        this.id = id;
        this.bjbh = bjbh;
        this.bjmc = bjmc;
        this.zybh = zybh;
