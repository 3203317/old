...
/**
 * JwxtXkxtZyxf entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name="JWXT_XKXT_ZYXF"
    ,schema="JWXT"
)

public class JwxtXkxtZyxf extends cn.newcapec.function.digitalcampus.common.model.AbstractModel implements java.io.Serializable {
	...
	/** minimal constructor */
    public JwxtXkxtZyxf(String id, String nj, String xq, String zyid, BigDecimal xxkms, Double xxkfs, BigDecimal gxkms, Double gxkfs, String cjr, String jlssdw, Date cjsj) {
        this.id = id;
        this.nj = nj;
        this.xq = xq;
        this.zyid = zyid;
    ...
    /** full constructor */
    public JwxtXkxtZyxf(String id, String nj, String xq, String zyid, BigDecimal xxkms, Double xxkfs, BigDecimal gxkms, Double gxkfs, String cjr, String jlssdw, Date whsj, Date cjsj) {
        this.id = id;
        this.nj = nj;
        this.xq = xq;
        this.zyid = zyid;
