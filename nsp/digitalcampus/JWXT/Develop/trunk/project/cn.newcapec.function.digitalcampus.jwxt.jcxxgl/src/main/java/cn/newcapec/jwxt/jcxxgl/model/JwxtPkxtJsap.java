...
/**
 * JwxtPkxtJsap entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name="JWXT_PKXT_JSAP"
    ,schema="JWXT"
)

public class JwxtPkxtJsap extends cn.newcapec.function.digitalcampus.common.model.AbstractModel implements java.io.Serializable {
	...
	/** minimal constructor */
    public JwxtPkxtJsap(String id, String jgh, String xq, String skjcid, String qzzc, String yqlxm, String cjr, String jlssdw, Date cjsj) {
        this.id = id;
        this.jgh = jgh;
        this.xq = xq;
        this.skjcid = skjcid;
    ...
    /** full constructor */
    public JwxtPkxtJsap(String id, String jgh, String xq, String skjcid, String qzzc, String yqlxm, String bz, String cjr, String jlssdw, Date whsj, Date cjsj) {
        this.id = id;
        this.jgh = jgh;
        this.xq = xq;
        this.skjcid = skjcid;
