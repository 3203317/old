...
/**
 * JwxtJxjhXqjh entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name="JWXT_JXJH_XQJH"
    ,schema="JWXT"
)

public class JwxtJxjhXqjh extends cn.newcapec.function.digitalcampus.common.model.AbstractModel implements java.io.Serializable {
	...
	/** minimal constructor */
    public JwxtJxjhXqjh(String id, String jhpcbh, String pyccm, String kkmsm, String yx, String zy, String sknj, String skxq, String ssjys, String kch, BigDecimal zxf, String sfxwk, String cjr, String jlssdw, Date cjsj) {
        this.id = id;
        this.jhpcbh = jhpcbh;
        this.pyccm = pyccm;
        this.kkmsm = kkmsm;
