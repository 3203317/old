 ...
 */
/** 
 * <p>Title: ModelSaveOrUpdateListener</p>  
 * <p>Description: </p>  
 ...
 * 复审人：
 */
public interface SaveOrUpdateListener extends ModelListener {
	void onSaveOrUpdate(SoftTopService service) throws CapecException;
}
