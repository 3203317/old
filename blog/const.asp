...
Is301 = 1    '301开关
if Is301 = 1 then
	Dim ScriptAddress, NewDomain, GetDomain, qs
	NewDomain = "http://www.foreworld.net"   '你的博客地址
	...
	qs = Lcase(Request.QueryString)   
	if qs <> "" then ScriptAddress = ScriptAddress & "?" & qs   '路径及文件名+参数
	if GetDomain <> NewDomain then   '301重定向
		Response.Status="301 Moved Permanently" 
		'Response.AddHeader "Location",NewDomain & ScriptAddress	'原始代码
		Response.AddHeader "Location",NewDomain					'修改后代码 不带 default.asp
		Response.End
	end if
end if
...
Const CookieName = "foreworld"
Const CookieNameSetting = "foreworld.net"
...
'Const AccessFile = "blogDBLP/PBLog3.asp"
Const AccessFile = "../database/PBLog3.asp"
