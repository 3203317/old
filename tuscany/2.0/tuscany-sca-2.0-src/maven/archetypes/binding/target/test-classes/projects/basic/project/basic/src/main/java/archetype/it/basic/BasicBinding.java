...
/**
 * Represents a binding to a Basic service.
 */
public class BasicBinding extends BaseBindingImpl {

    public static final QName TYPE = new QName(SCA11_TUSCANY_NS, "binding.basic");
